<nav class="nav justify-content-between menu-nav menu_desplegable_navbar mt-2 mb-3 text-dark"
    ...
    @if (session()->has('user'))
        @if (!empty(session('user')))
            ...
            <<<<<<< HEAD @if (session()->has('user'))  @if (!empty(session('user')))
                ...
                @if (session('user')->type_user == 'C')
                    ...
                    href="/show_usuario/{{ session('user')->id }}">Mi cuenta</a>
                    ...
                    @if (session('user')->type_user == 'C')
                        ...
                        >>>>>>> 97a1b6ef3ca843554cad8aa1071f447ed1eceffa
                        </div>
                    @else
                        <div class="dropdown">
                        <button class="btn btn-info dropdown-toggle" type="button"
