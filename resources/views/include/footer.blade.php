<div class="col-lg-12 align-items-center justify-content-center row ">
    <div class="col-lg-6 col-md-6 col-sm-12  mb-3">
        <p class=" mr-2 text-primary">Ubicacio:</p> <iframe class="d-flex mx-auto"
            ...
            width="600" height="450" style="border:0; width:200px; height: 200px" allowfullscreen=""
            loading="lazy"></iframe>
    ...
    <div class="col-lg-6 col-md-6 col-sm-12">
        <p class="text-primary">
            ...
            Email: admin@trailrunningworld.es<br>
