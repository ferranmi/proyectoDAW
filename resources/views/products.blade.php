        ...
        <div class="col-lg-6">
            <div class="card flex-md-row mb-5 box-shadow h-md-250 div-products-targetas mx-auto">
                <div class="card-body d-flex flex-column align-items-start  ">
                    ...
                    <p class="card-text mb-auto ">Es una gran final una mica diferent, l'any 2020 la final de les golden world trail series
                        es va fer en 4 etapes.</p>
                    <a href="#">Continue reading</a>
                </div>
            <img class=" card-img-right flex-auto d-none d-md-block "  style="width: 200px; height: 225px;"
            src="./images/azores.jpg"
        ...
        <div class="col-lg-6 ">
            <div class="card flex-md-row div-products-targetas mx-auto">
                <div class="card-body d-flex flex-column align-items-start">
                    ...
                    <p class="card-text">Despres de la caiguda del titan dels 42km de la Zegama Aizkorri finalment sera la olla de nuria
                            qui formara part aquesta temporada de les golden world Trail series.</p>
                    <a href="#">Continue reading</a>
                </div>
                <img class="card-img-right flex-auto d-none d-md-block" data-src="holder.js/200x250?theme=thumb"
                    alt="Thumbnail [200x250]"
                    src="./images/Olla_de_Nuria.jpg"
                    data-holder-rendered="true" style="width: 200px; height: 225px;">
            </div>
        </div>
    </div>
              ...
              <div class="col-lg-3 ">
                <div class="card mb-4 box-shadow targetas-products">
                  <img class="card-img-top"
                    data-src="holder.js/100px225?theme=thumb&amp;bg=55595c&amp;fg=eceeef&amp;text=Thumbnail"
                    alt="Thumbnail [100%x225]"
                    src="data:image/svg+xml;charset=UTF-8,%3Csvg%20width%3D%22348%22%20height%3D%22225%22%20xmlns%3D%22http%3A%2F%2Fwww.w3.org%2F2000%2Fsvg%22%20viewBox%3D%220%200%20348%20225%22%20preserveAspectRatio%3D%22none%22%3E%3Cdefs%3E%3Cstyle%20type%3D%22text%2Fcss%22%3E%23holder_179665e1b59%20text%20%7B%20fill%3A%23eceeef%3Bfont-weight%3Abold%3Bfont-family%3AArial%2C%20Helvetica%2C%20Open%20Sans%2C%20sans-serif%2C%20monospace%3Bfont-size%3A17pt%20%7D%20%3C%2Fstyle%3E%3C%2Fdefs%3E%3Cg%20id%3D%22holder_179665e1b59%22%3E%3Crect%20width%3D%22348%22%20height%3D%22225%22%20fill%3D%22%2355595c%22%3E%3C%2Frect%3E%3Cg%3E%3Ctext%20x%3D%22116.71875%22%20y%3D%22120.3%22%3EThumbnail%3C%2Ftext%3E%3C%2Fg%3E%3C%2Fg%3E%3C%2Fsvg%3E"
                    data-holder-rendered="true" style="height: 225px; width: 100%; display: block;">
                  <div class="card-body">
                    <p class="card-text">This is a wider card with supporting text below as a natural lead-in to additional
                      content.
